#!/usr/bin/env python3
"""
Phase 8.3: Nested Optuna-LOSO Completion
...
RESULTS_DIR = PROJECT_ROOT / 'results' / 'phase8_3_nested_loso'
...
def generate_report(results: Dict, summary: Dict) -> str:
    ...
    report = f"""# Phase 8.3: Nested Optuna-LOSO - Final Report
...
*Generated by Phase 8.3 Nested Optuna-LOSO Pipeline*
"""
...
def generate_outputs(results: Dict, summary: Dict):
    ...
    with open(RESULTS_DIR / 'phase8_3_report.md', 'w') as f:
        f.write(report)
    print("  Saved: phase8_3_report.md")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Phase 8.3: Nested Optuna-LOSO')
    parser.add_argument('--resume', action='store_true', help='Resume from checkpoint')
    args = parser.parse_args()

    print("="*70)
    print("PHASE 8.3: NESTED OPTUNA-LOSO TO BEAT PAPER 1")
    print("="*70)
